---
id: "notes.ai-engineering.claude-code-loop-setup"
title: "Practical Loop Setup in Claude Code: From Messenger to Reviewer"
description: "Implementasi praktis loop engineering menggunakan CLAUDE.md, settings.json hooks, dan fixer sub-agent untuk memastikan kode terverifikasi sebelum dianggap selesai."
tags:
  - claude-code
  - loop-engineering
  - automation
